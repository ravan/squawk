...
- **Annotation.** One immutable record in the session model: `rect`, `ellipse`, `arrow`, `pen`, `text`, `label`, or `color-sample`.
...
- **Armed tool.** The tool that currently owns pointer input on the Overlay. Exactly one of interact/select/rect/ellipse/arrow/pen/text/picker/eyedropper/eraser.
